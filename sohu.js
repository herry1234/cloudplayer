...
exports.config = function (cfg) {
	vid = cfg.vid;
	outfname = vid + '.txt';
	url = 'http://hot.vrs.sohu.com/vrs_flash.action?vid=' + vid + '&af=1&bw=1361&plid=1012140&out=0&g=7&t=0.06235922733321786';
	options = {
		url : url,
		proxy : cn_proxy
	};
...
function savetofile(data) {
	fd = fs.openSync(path.join(process.cwd(), outfname), 'a');
	var lengh_of_list = 0;
